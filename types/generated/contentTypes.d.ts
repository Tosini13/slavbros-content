...
export interface ApiNutricionezArticleNutricionezArticle
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::nutricionez-article.nutricionez-article'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiNutricionezServiceNutricionezService
  ...
  info: {
    description: '';
    displayName: '(nutricionez) services';
    pluralName: 'nutricionez-services';
    singularName: 'nutricionez-service';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::nutricionez-service.nutricionez-service'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
